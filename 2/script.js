...
(function initMarquee() {
  ...
  const text = "INDIA'S NO.1 DABBA MARKET COMPANY";
  const separator = '⬥';
  let html = '';
...
console.log('%c🐂 TRADE ANGEL 8 — India\'s #1 Dabba Market Company', 'color: #00ff88; font-size: 16px; font-weight: bold; background: #050a08; padding: 10px 20px; border-radius: 8px;');
console.log('%cOpen Account: wa.me/919999999999', 'color: #25D366; font-size: 12px;');
